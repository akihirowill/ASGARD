		 ...
		 if( $title !='' || $number!='' )
		   $counters .= '<div class="col-md-3">
			  <div class="magee-counter-box">
				<div class="counter onetone-counter '."counter_number_".$c."_".$i.'"><span class="counter-num js-counter" data-from="0" data-to="'.absint($number).'" data-speed="3000" data-refresh-interval="50"></span></div>
