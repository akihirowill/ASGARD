<?php
 ...
 function onetone_setup(){
  ...
  global $content_width, $onetone_options, $onetone_options_db,$onetone_options_default;
  ...
  if($onetone_options)
	...
	require_once  get_template_directory() . '/lib/kirki/options.php';
}

add_action( 'after_setup_theme', 'onetone_setup' );


function onetone_after_switch_theme($oldname, $oldtheme=false) 
{
	...
	if( $show_on_front == 'page' && $page_on_front>0 && $_wp_page_template !='template-home.php' ){
  		update_post_meta( $page_on_front, '_wp_page_template', 'template-home.php' );
  	}
 }
add_action("after_switch_theme", "onetone_after_switch_theme", 10 , 2);


function onetone_custom_scripts(){
	
	global $page_meta,$post,$shop_style, $onetone_home_sections, $onetone_options;
	...
	$section_content_css .=  "body{".$section_css."}";
	...
	$section_content_css .=  ".section_service_".$i." i{".$service_icon_color."}";
	

	$content_nosize_typography = '';
	if ( isset( $content_typography['font-family'] ) )
		$content_nosize_typography .= "font-family:".$content_typography['font-family'].";";

	if ( isset( $content_typography['variant'] ) )
		$content_nosize_typography .= "font-variant:".$content_typography['variant'].";";

	if ( isset( $content_typography['letter-spacing'] ) ) 
		$content_nosize_typography .= "letter-spacing:".$content_typography['letter-spacing'].";";
		
	if ( isset( $content_typography['color'] ) ) {
		$content_nosize_typography .= "color:".$content_typography['color'].";";
		$rgb = onetone_hex2rgb($content_typography['color']);
		$section_content_css .= "section.home-section-".$i." .home-section-content .person-social i,
		section.home-section-".$i." .banner-sns li a i,
		section.home-section-".$i." input,
		section.home-section-".$i." select,
		section.home-section-".$i." textarea,
		...
		section.home-section-".$i." .home-section-content h6{color:".$content_typography['color'].";}\r\n";
		
		$section_content_css .= "section.home-section-".$i." input,
		section.home-section-".$i." select,
		section.home-section-".$i." textarea{border-color:".$content_typography['color'].";}\r\n";
		
		$section_content_css .= ".onetone section.home-section-".$i." .magee-btn-normal.btn-line{color: ".$content_typography['color'].";border-color: ".$content_typography['color'].";}\r\n";
		...
		if($v['type']==11){
			$section_content_css .= "section.home-section-".$i." .entry-meta i,section.home-section-".$i." .entry-meta a,section.home-section-".$i." img{color:".$content_typography['color']."}";
		}
	
	}
	if ( isset( $title_typography['color'] ) ) {
		$section_content_css .= "section.home-section-".$i." .heading-inner{border-color:".$title_typography['color']."}\r\n";
	}
	...
	if($v['type']==11){
		...
		$section_content_css .= "section.home-section-".$i." .home-section-content p,
		section.home-section-".$i." .home-section-content h1,
		section.home-section-".$i." .home-section-content h2,
		section.home-section-".$i." .home-section-content h3,
		section.home-section-".$i." .home-section-content h4,
	...
	$onetone_custom_css = str_replace('&gt;','>',$onetone_custom_css);
	...
	wp_enqueue_script( 'jquery-countto', get_template_directory_uri() . '/plugins/jquery.countTo.js', array( 'jquery'), '1.0', true );
	...
	$i18n = array(
				'i1'=> __('Please fill out all required fields.','onetone' ),
				'i2'=> __('Please enter valid email.','onetone' ),
				'i3'=> __('Please enter your name.','onetone' ),
				'i4'=> __('Message is required.','onetone' ),
				);
...
function onetone_customize_control_js() {
	...
	$confirm_import  = esc_js( __( 'Click OK to import. Any onetone options will be overwritten!', 'onetone' ) );
