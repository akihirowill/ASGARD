...
global $onetone_options, $onetone_options_db;
if(!$onetone_options){
...
function onetone_option($name,$default=''){
	global $onetone_options_default, $onetone_options_db;
	
	if(function_exists('is_customize_preview') && is_customize_preview()){
		$textdomain = onetone_option_name();
...
*/
 function onetone_save_options(){
	 ...
	 global $onetone_options_saved,$onetone_home_sections;
...
add_action( 'init', 'onetone_allow_tags' );
...
function onetone_handle_editor_view_js() {
	...
	wp_localize_script( 'grunion-editor-view', 'grunionEditorView', array(
			...
			'default_form'  => '[contact-field label="' . __( 'Name', 'onetone' ) . '" type="name"  required="true" /]' .
								'[contact-field label="' . __( 'Email', 'onetone' )   . '" type="email" required="true" /]' .
								'[contact-field label="' . __( 'Website', 'onetone' ) . '" type="url" /]' .
								'[contact-field label="' . __( 'Message', 'onetone' ) . '" type="textarea" /]',
			'labels'      => array(
...
add_filter( 'options-framework/fonts/standard_fonts', 'onetone_standard_fonts' );
   ...
   $options[] =  array(
	   ...
	   'fields' => array(
		  ...
		  'icon' => array(
			  'type'        => 'text',
			  'label'       => esc_attr__( 'Icon', 'onetone' ),
			  'description' => 'FontAwesome Icon, e.g. facebook',
			  'default'     => '',
		  ),
		  'title' => array(
			  'type'        => 'text',
...
// Blog
	...
	$options[] =  array(
		 ...
		 'label'       => __( 'Page Title Bar Top Padding', 'onetone' ),
		  'description'        => __( 'In pixels, ex: 210px', 'onetone' ),
		  'default'         => '50px',
		  'type'        => 'text',
		  'section'     => 'onetone_page_title_bar_options',
	);
	...
	$options[] =  array(
		 ...
		 'label'       => __( 'Page Title Bar Bottom Padding', 'onetone' ),
		  'description'        => __( 'In pixels, ex: 160px', 'onetone' ),
		  'default'         => '50px',
		  'type'        => 'text',
		  'section'     => 'onetone_page_title_bar_options',
	);
	$options[] =  array(
		 ...
		 'label'       => __( 'Page Title Bar Mobile Top Padding', 'onetone' ),
		  'description'        => __( 'In pixels, ex: 70px', 'onetone' ),
		  'default'         => '10px',
		  'type'        => 'text',
		  'section'     => 'onetone_page_title_bar_options',
	);
	...
	$options[] =  array(
		 ...
		 'label'       => __( 'Page Title Bar Mobile Bottom Padding', 'onetone' ),
		  'description'        => __( 'In pixels, ex: 50px', 'onetone' ),
		  'default'         => '10px',
		  'type'        => 'text',
		  'section'     => 'onetone_page_title_bar_options',
	);
	...
	$options[] = array(
		  ...
		  'default'=>array('background-color' => '',
			  'background-image' => esc_url(onetone_option_saved('page_title_bar_background')),
			  'background-repeat'     => '',
			  'background-position'   => 'top-left',
	...
	$options[] = array(
		  ...
		  'description' => '',
		  'default'=>array('background-color' => '',
			  'background-image' => esc_url(onetone_option_saved('page_title_bar_retina_background')),
			  'background-repeat'     => '',
			  'background-position'   => 'top-left',
			  'background-size'       =>onetone_option_saved('page_title_bg_full')=="yes"?'cover':'',
			  'background-attachment' => ''
...
// sidebar
 ...
 $options[] = array(
  ...
  $options[] =  array(
	...
	$options[] = array(
		...
		'default'=>array('background-color' => onetone_option_saved('header_background_color'),
 ...
 if( $button_font == '' )
  ...
  $options[] =  array(
		  'slug'        => 'google_fonts',
		 'label'        => __( 'Load Google Fonts', 'onetone' ),
		  'description' => __( 'Default: Open+Sans:300,400,700|Yanone+Kaffeesatz', 'onetone' ),
		  'default'     => 'Open+Sans:300,400,700|Yanone+Kaffeesatz|Lustria',
		  'type'        => 'text',
...
function onetone_admin_notices(){
	...
	if( $dismiss != '1' )
		$notice  = '<div class="options-to-customise notice notice-error is-dismissible" style="display:block !important;">
	        <p>'.sprintf(__( 'Theme Options have been migrated to <a href="%s">customize</a>.', 'onetone' ), admin_url('customize.php')).'</p></div>';
		echo $notice;
}
add_action( 'admin_notices', 'onetone_admin_notices' );
...
function onetone_options_export(){
  ...
  echo @json_encode($onetone_backup_options, JSON_UNESCAPED_SLASHES);
  exit(0);
}
...
if (class_exists('WooCommerce')) {
	...
	if(!function_exists('onetone_woocommerce_output_content_wrapper')){
	...
	if(!function_exists('onetone_woocommerce_output_content_wrapper_end')){
